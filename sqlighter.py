...
class SQLighter:
	...
	def bizno3s(self, user_id):
		with self.connection:
			...
			if result[0][6] == 1:
				if result[0][4] >= 5000:
					self.cursor.execute('UPDATE `user_info` SET `point` = ? WHERE `user_id` = ?', (result[0][4]-5000, user_id))
				...
				if result[0][4] >= 200000:
					self.cursor.execute('UPDATE `user_info` SET `point` = ? WHERE `user_id` = ?', (result[0][4]-200000, user_id))
	...
	def chek2(self,user_id):
		with self.connection:
			result = self.cursor.execute('SELECT * FROM `user_info` WHERE `user_id` = ?', (user_id,)).fetchall()
			self.cursor.execute('UPDATE `user_info` SET `chek2` = ? WHERE `user_id` = ?', (0, user_id))
			return result[0][12]
	...
	def biznos(self, user_id):
		with self.connection:
			result = self.cursor.execute('SELECT * FROM `user_info` WHERE `user_id` = ?', (user_id,)).fetchall()
			if result[0][6] == 1:
				return '(Ваш бизнес)','(5000🧿)','','','','','','','',result[0][10],result[0][9]
			if result[0][6] == 2:
				return '','(Ваш бизнес)','(10000🧿)','','','','','','',result[0][10],result[0][9]
			if result[0][6] == 3:
				return '','','(Ваш бизнес)','(15000🧿)','','','','','',result[0][10],result[0][9]
			if result[0][6] == 4:
				return '','','','(Ваш бизнес)','(30000🧿)','','','','',result[0][10],result[0][9]
			if result[0][6] == 5:
				return '','','','','(Ваш бизнес)','(45000🧿)','','','',result[0][10],result[0][9]
			if result[0][6] == 6:
				return '','','','','','(Ваш бизнес)','(80000🧿)','','',result[0][10],result[0][9]
			if result[0][6] == 7:
				return '','','','','','','(Ваш бизнес)','(200000🧿)','',result[0][10],result[0][9]
			if result[0][6] == 8:
				return '','','','','','','','(Ваш бизнес)','(1000000🧿)',result[0][10],result[0][9]
			if result[0][6] == 9:
